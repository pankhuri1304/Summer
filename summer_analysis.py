...
with col2:
    st.markdown('<a href="https://pankhuri1304-front-front-85jphc.streamlit.app/" style="padding: 8px 10px; background-color: white; color: Black; text-align: center; text-decoration: none; display: inline-block; border-radius: 4px; border: 1px solid black; cursor: pointer;">Home</a>', unsafe_allow_html=True)
